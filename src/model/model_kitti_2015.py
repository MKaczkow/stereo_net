...
class StereoNet(pl.LightningModule):
    ...
    def forward_pyramid(self, sample, side: str = 'left') -> List[torch.Tensor]:
        """
    ...
    def forward(self, sample) -> torch.Tensor:  # type: ignore[override] # pylint: disable=arguments-differ
        """
    ...
    def training_step(self, batch, _) -> torch.Tensor:  # type: ignore[override, no-untyped-def] # pylint: disable=arguments-differ
        """
    ...
    def validation_step(self, batch, batch_idx: int) -> None:  # type: ignore[override] # pylint: disable=arguments-differ
        """
